...
import com.studioannwn.model.PyramidModel;
...
public class PyramidLayout {
	...
	public PyramidLayout() {
		model = new PyramidModel();

		int universeNumber = 1;
		List<LXModel> spotlights = ModelCollection.filterChildren(model, "spotlight");
		List<LXModel> wallWashers = ModelCollection.filterChildren(model, "wall-washer");
